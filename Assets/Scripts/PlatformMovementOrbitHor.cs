...
public class PlatformMovementOrbitHor : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        Vector3 offset = new Vector3(Mathf.Cos((Time.time * orbitSpeed) + phaseOffset) * radius, 0f, Mathf.Sin((Time.time * orbitSpeed) + phaseOffset) * radius);
